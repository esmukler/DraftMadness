...
ActiveRecord::Schema.define(version: 2026_03_15_000000) do
  ...
  create_table "games", id: :serial, force: :cascade do |t|
    ...
    t.index ["school1_id"], name: "index_games_on_school1_id"
    t.index ["school2_id"], name: "index_games_on_school2_id"
  end
  ...
  create_table "owner_schools", id: :serial, force: :cascade do |t|
    ...
    t.index ["owner_id"], name: "index_owner_schools_on_owner_id"
    t.index ["school_id", "league_id"], name: "index_owner_schools_on_school_id_and_league_id"
    t.index ["school_id", "owner_id"], name: "index_owner_schools_on_school_id_and_owner_id"
    t.index ["school_id"], name: "index_owner_schools_on_school_id"
  end
